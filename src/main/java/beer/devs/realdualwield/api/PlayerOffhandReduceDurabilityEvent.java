...
public class PlayerOffhandReduceDurabilityEvent extends Event implements Cancellable
{
    ...
    public PlayerOffhandReduceDurabilityEvent(PlayerInteractEntityEvent event)
    {
