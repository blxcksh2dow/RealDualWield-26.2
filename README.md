...
| **Delay d'attacco** | Il cooldown della seconda mano usa l'`attack-speed` MMOItems (`20 / attacchi al secondo`, limitato da `min-cooldown` / `max-cooldown`) invece dei 12 tick fissi; il danno viene scalato sulla durata reale del cooldown. |
